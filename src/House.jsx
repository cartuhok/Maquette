...
import { useGLTF, useTexture, ScrollControls, useScroll, Html, OrbitControls, Sparkles } from "@react-three/drei"
...
export default function House(props) {
  ...
  <>
    ...
    <group {...props} dispose={null} scale={props.camera ? 1 : 0.15} position={!props.camera && [0,-1,0]}>
      ...
      {/* <Sparkles count={20} scale={100} size={20} speed={0.4} color={'#f6e8db'} /> */}
